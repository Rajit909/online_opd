...
import { View, Text, StyleSheet, Image, TouchableOpacity, Switch, SafeAreaView, ScrollView, ActivityIndicator, RefreshControl, Dimensions, PixelRatio, BackHandler, Alert } from 'react-native';
  ...
  return (
    ...
    <SafeAreaView className=' h-full dark:bg-primary dark:text-white'>
      ...
      <View style={styles.profileSection}>
        ...
        />
        <Text className=" dark:text-white"  style={styles.profileName}>{user? user.name: "Guest"}</Text>
        <Text style={styles.profilePhone} className=" dark:text-white">{user? user.mobile: " "}</Text>
      </View>
